...
async function generateSitemap() {
  ...
  await fsExtra.outputFile(sitemapPath, sitemap, { encoding: 'utf-8' })
  ...
  await fsExtra.outputFile(robotsTxtPath, robotsTxtContents, { encoding: 'utf-8' })
}
...
async function getSitemap(allPageSuffixes) {
  const smStream = new SitemapStream({ hostname: 'https://mehdisaffar.github.io/learning-notes' })
